(function ($) {
  ...
  if ($("#visit-sale-chart").length) {
    ...
    const bgPurpal1 = ["rgba(218, 140, 255, 1)"];
    const bgPurpal2 = ["rgba(54, 215, 232, 1"];
    const bgPurpal3 = ["rgba(255, 191, 150, 1)"];
  ...
  if ($("#traffic-chart").length) {
    ...
    // const bgPurpal1 = ["rgba(54, 215, 232, 1)"];
    // const bgPurpal2 = ["rgba(255, 191, 150, 1"];
    // const bgPurpal3 = ["rgba(6, 185, 157, 1)"];
